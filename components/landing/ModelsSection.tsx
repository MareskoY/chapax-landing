...
const models = [
  ...
  { id: 'banana', name: 'Nano Banana Pro', logo: '/models/banana.svg', isNew: false },
  { id: 'sora', name: 'Sora', logo: '/models/sora.png', isNew: false },
  { id: 'kling', name: 'Kling', logo: '/models/kling.webp', isNew: true },
  { id: 'vidu', name: 'Vidu', logo: '/models/vidu.webp', isNew: true },
  { id: 'seedance', name: 'Seedance', logo: '/models/seedance.webp', isNew: true },
  { id: 'ovi', name: 'Ovi', logo: '/models/ovi.png', isNew: true },
